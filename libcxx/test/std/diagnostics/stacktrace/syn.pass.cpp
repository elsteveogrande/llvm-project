...
int main(int, char**) {
  ...
  // Only checking for types' and functions' existence.
  // Everything stacktrace-related is tested in one of the other .cpp's in this directory.
  ...
  using T4 = decltype(std::swap(*a, *b));
